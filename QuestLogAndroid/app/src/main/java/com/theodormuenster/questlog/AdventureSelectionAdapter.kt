...
class AdventureSelectionAdapter(private val AdventureList: ArrayList<AdventureData>): RecyclerView.Adapter<AdventureSelectionAdapter.AdventureSelectionViewHolder>() {

    class AdventureSelectionViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(
        ...
        return AdventureSelectionViewHolder(itemView)
    }
